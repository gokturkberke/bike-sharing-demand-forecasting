...
CELLS = [
    ...
    new_markdown_cell(
        ...
        "holdout RMSLE 0.91 -> 0.72 with no tree regression at all) and did "
        "not promote the rest: the environmental products regressed the "
        "trees, while the peaks and year flag only helped Ridge and were "
        "redundant with the cyclic encoding.\n"
